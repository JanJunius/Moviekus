...
{
    /// <summary>
    /// Die Klasse bildet die Web-Validierung nach, d.h. die Model-Attribute zur Validierung (ValidationAttribute) werden ausgewertet
    /// Allerdings müssen die Labels zur Anzeige auf der Page selbst gesetzt werden. Diese müssen sich folgender Namenskonvention anpassen:
    /// Model_Property + Suffix Error
    /// Bsp: <Label x:Name="Movie_TitleError" IsVisible="False" TextColor="Red" />
    /// Movie heißt die Model-Property, Title ist die gebundene Property im Model
    /// </summary>
